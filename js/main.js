...
const TotalPrecioTemplate = document.getElementById(
	'TotalPrecioTemplate'
);
// fragment
...
const pintarCarrito = () => {
	...
	carritoArray.forEach(item => {
		...
		const clone =
			liTemplete.content.firstElementChild.cloneNode(true);
		...
		clone.querySelector('.liProduct__btn--delite').dataset.id =
			item.id;
